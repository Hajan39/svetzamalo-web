...
export function ConsentBanner({
  ...
  const { consentStatus, grantConsent, denyConsent, canTrack } = useAnalyticsConsent()
  ...
  useEffect(() => {
    ...
    if (debug) {
      console.log('[ConsentBanner] Status:', { consentStatus, wasDismissed, shouldShow })
    }
  }, [consentStatus, debug])
      ...
      <div className="container-narrow">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            <h2 id="consent-title" className="text-lg font-semibold text-foreground mb-2">
              {t('consent.title')}
            </h2>
            <p id="consent-description" className="text-sm text-foreground-secondary leading-relaxed">
