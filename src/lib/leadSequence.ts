...
export const LEAD_SEQUENCE: SequenceStep[] = [
	{
		...
		html: () =>
			p("Z deseti chyb v ebooku je jedna zvláštní tím, že ji neuvidíš. Nepřeplatíš na hotelu ani na letence, ale na <strong>penězích samotných</strong>.") +
			p("Směnárna na letišti, dynamický přepočet měny na terminálu (na „chcete platit v CZK?“ nikdy nekývej), karta s poplatkem za výběr. Každá položka malá, dohromady klidně tisícovka za týden.") +
