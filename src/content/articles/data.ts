...
export const articles: Article[] = [
  {
    ...
    seo: {
      metaTitle: 'Dominican Republic: Complete Travel Guide 2026 | Lowcost Traveling',
      metaDescription:
  ...
  },
  {
    ...
    seo: {
      ...
      keywords: ['vatican', 'rome', 'sistine chapel', 'st peters basilica', 'italy travel'],
      ogImage: {
  ...
  },
  {
    ...
    seo: {
      ...
      keywords: ['thailand', 'bangkok', 'phuket', 'chiang mai', 'thai islands', 'budget travel asia'],
      ogImage: {
  ...
  },
  {
    ...
    seo: {
      ...
      keywords: ['portugal', 'lisbon', 'porto', 'algarve', 'europe travel', 'budget travel europe'],
      ogImage: {
  ...
  },
  {
    ...
    seo: {
      ...
      keywords: ['morocco', 'marrakech', 'sahara', 'fes', 'chefchaouen', 'africa travel'],
      ogImage: {
  ...
  },
  {
    ...
    seo: {
      ...
      keywords: ['bali', 'indonesia', 'ubud', 'seminyak', 'southeast asia', 'budget travel'],
      ogImage: {
