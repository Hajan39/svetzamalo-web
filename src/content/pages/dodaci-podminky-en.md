...
description: Delivery and payment information for the Svět za málo e-shop.
---
...
All products in this e-shop are **digital** (ebook in PDF or EPUB format). No physical goods are shipped.
...
All prices are in Czech Koruna (CZK). The operator is not a VAT payer.

## Technical Requirements

To open the PDF ebook, you need Adobe Acrobat Reader or any PDF viewer. EPUB format is readable in standard e-book readers (Kindle, Kobo, Apple Books, etc.).
