const cs = {
	...
	pages: {
		home: {
			...
			heroBody:
				"Destinace, itineráře, rozpočty a konkrétní tipy pro cestování bez zbytečného luxusu i bez zbytečných chyb.",
		...
		articlesIndex: {
			...
			foundWithFilters: (count: number) =>
				`Nalezeno článků podle filtrů: ${count}`,
		...
		destinationContinent: {
			title: (continentTitle: string) =>
				`${continentTitle} | Destinace | Svět za málo`,
			description: (continentTitle: string) =>
				`Lowcost destinace v oblasti ${continentTitle}.`,
		...
		book: {
			...
			buyGuide: "Koupit průvodce",
			sampleKicker: "Ukázka zdarma",
			sampleTitle: "Přečti si celou kapitolu, než se rozhodneš",
			sampleText: "Kapitola „Peníze a platební karty“ (7 stran) plus obsah celé knihy. Pošleme ji na e-mail, spolu s pár tipy z dalších kapitol.",
			sampleButton: "Poslat ukázku na e-mail",
			sampleNote: "Žádný spam. Odhlásit se dá jedním klikem.",
			sampleSuccess: "Hotovo. Ukázka je na cestě, zkontroluj i hromadnou poštu.",
		...
		bookSuccess: {
			...
			sampleHeading: "Ukázka je tvoje",
			sampleIntro: "Poslali jsme ji na e-mail. Stáhnout si ji můžeš i rovnou tady.",
			sampleDownload: "Stáhnout ukázku (PDF)",
			leadIntro:
		...
		ebookDownload: {
			...
			paidIntro:
				"Platba je potvrzená a tvoje kniha je připravená. Díky, že podporuješ Svět za málo.",
			paidBody:
				"Odkaz je osobní, jednorázový a časově omezený. Po kliknutí ti stránka vygeneruje krátkodobý odkaz ke stažení.",
			freeIntro:
				"Kliknutím pokračuj na zabezpečené stažení ebooku. Odkaz může být časově omezený.",
			downloadPaid: "Stáhnout zakoupenou knihu",
			downloadPaidPdf: "Stáhnout PDF",
			downloadPaidEpub: "Stáhnout EPUB",
			downloadFree: "Stáhnout ebook",
			loading: "Připravuji zabezpečené stažení...",
			error:
				"Odkaz je neplatný, expirovaný nebo už použitý. Odpověz na email a pošleme nový.",
			missingPaid:
				"Chybí token pro stažení zakoupené knihy. Odpověz prosím na potvrzovací email a pošleme nový odkaz.",
		...
		about: {
			...
			description:
				"Kdo stojí za webem Svět za málo, jak tvoříme průvodce a proč věříme v praktické lowcost cestování.",
			who: "Kdo jsme",
			heroHeading: "Pomáháme cestovat levněji, ale ne hůř",
			heroBody:
				"Svět za málo je český cestovatelský projekt pro lidi, kteří chtějí vidět víc světa, plánovat chytře a nedělat drahé chyby jen proto, že jim před cestou chyběly konkrétní informace.",
			browseDestinations: "Procházet destinace",
			writeUs: "Napsat nám",
			...
			talksBody:
				"Web je základ, ale některé věci nejlépe fungují v živé besedě: příběhy z cest, konkrétní rozpočty, chyby, dotazy publika a srovnání různých stylů cestování.",
			...
			upcomingNote:
				"Termíny postupně upřesníme. Pro školy, knihovny nebo cestovatelské akce umíme připravit téma i na míru.",
			contact: "Kontakt",
			contactHeading: "Máte tip, dotaz nebo chcete spolupráci?",
			contactBody:
				"Napište nám. Hodí se nám zpětná vazba k článkům, tipy na destinace i poptávky přednášek nebo cestovatelských besed.",
			principles: [
				{
			...
			stats: [
				{
					value: "2020",
					label: "od roku, kdy web pomáhá cestovatelům plánovat levněji",
				},
				{
					value: "300+",
					label:
			...
			pastEvents: [
				...
				{
					date: "31. 1. 2020",
					title: "Vietnam s Káťou a Honzou",
					place: "Dolní Habartice",
